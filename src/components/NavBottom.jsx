...
export default function NavBottom() {
  return (
    <>
      <div className="md:hidden fixed bottom-0 bg-primary h-[76px] flex items-center justify-between w-full px-5 py-2 text-white">
        <Link to="" className="flex flex-col gap-1 items-center">
          <img src={nav_home} alt="" className="w-[37px]" />
